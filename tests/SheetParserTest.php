...
class SheetParserTest extends TestCase
{
    ...
    public function testPatternMatchesOnlyOnce()
    {
        ...
        $rows = iterator_to_array($parser->getDataIterator());
        $first = reset($rows);
        /** PhpSpreadsheet 把字符串 '1' 推断为 numeric cell, 修复后从 getCalculatedValue 拿到的是 int 1 */
    ...
    public function testNumericFormatNotTruncated(): void
    {
        ...
        $sheet->setCellValue('D2', \PhpOffice\PhpSpreadsheet\Shared\Date::PHPToExcel(new \DateTime('2026-05-27 15:30:00')));
